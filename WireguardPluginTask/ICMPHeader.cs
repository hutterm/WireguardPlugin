...
/*
 * from https://www.winsocketdotnetworkprogramming.com/clientserversocketnetworkcommunication8f_1.html
 */
namespace WireguardPluginTask
{

        /// <summary>
        /// This class contains some of the common ioctl definitions typically passed
        /// to the Socket.IOControl method.
        /// </summary>
        class WinsockIoctl
        {
            /// <summary>
        ...
        /// <summary>
        /// This class contains routines for converting an IPEndPoint to and from the binary
        /// 'struct sockaddr' structures the underlying Winsock interface expects in the
        ...
        /// <summary>
        /// This header is used when an IPv6 packet requires fragmenting. The IPv4 stack
        /// will fragment raw IPv4 packets, but the IPv6 stack will not. The application
        /// is expected to fragment the packet before sending. This class represents the
        ...
        /// <summary>
        /// This is the IGMP (version 1 and 2) protocol header. The IGMP protocol is used
        /// to advertise and query IPv4 multicast group membership.
        /// </summary>
        ...
        /// <summary>
        /// ICMPv6 protocol header which is used for control messages over the IPv6
        /// protocol.
        /// </summary>
        class Icmpv6Header : ProtocolHeader
        {
            ...
            // Comman values for the ICMPv6 type and code fields
        ...
        class Icmpv6EchoRequest : ProtocolHeader
        {
            ...
            public override byte[] GetProtocolPacketBytes(byte[] payLoad)
            {
                byte[] icmpv6EchoRequestHeader = new byte[Icmpv6EchoRequestLength + payLoad.Length],
                            byteValue;
                int offset = 0;
